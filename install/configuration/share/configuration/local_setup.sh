...
: ${AMENT_CURRENT_PREFIX:="/home/zeeshan/ros2_ws/install/configuration"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/configuration/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/configuration/environment/path.sh"
